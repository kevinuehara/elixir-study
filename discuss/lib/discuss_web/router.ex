defmodule DiscussWeb.Router do
  ...
  scope "/", DiscussWeb do
    ...
    # #option 1.2 : resources "/topics", TopicController  // we can use a default and remove above routes but must follow the restfull pattern
